 ...
 */
@Data
@ApiModel(value = "TmUser查询返回对象", description = "查询返回实体对象")
public class ResTmUser implements Serializable {
    ...
    private Map<String, Map<String, Map<String, List<ResTmRoleVO>>>> userRoleFunction;
